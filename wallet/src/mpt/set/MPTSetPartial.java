...
public class MPTSetPartial implements AuthenticatedSetClient {
	...
	public static MPTSetPartial deserialize(byte[] asbytes) throws InvalidSerializationException {
		MerklePrefixTrie mpt;
		try {
			mpt = MerklePrefixTrie.parseFrom(asbytes);
	 ...
	 */
	public static MPTSetPartial deserialize(MerklePrefixTrie mptPartial) throws InvalidSerializationException{
	...
	public MerklePrefixTrie serialize() {
		...
		MerklePrefixTrie.Builder builder = MerklePrefixTrie.newBuilder();
