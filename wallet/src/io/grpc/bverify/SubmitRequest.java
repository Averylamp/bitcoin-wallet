...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return Api.internal_static_api_SubmitRequest_descriptor;
  }

  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return Api.internal_static_api_SubmitRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            SubmitRequest.class, Builder.class);
  }
  ...
  public static SubmitRequest parseFrom(
  ...
  public static SubmitRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static SubmitRequest parseFrom(
  ...
  public static SubmitRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static SubmitRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static SubmitRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(SubmitRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public SubmitRequest build() {
      SubmitRequest result = buildPartial();
    ...
    public SubmitRequest buildPartial() {
      SubmitRequest result = new SubmitRequest(this);
      if (requestCase_ == 1) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof SubmitRequest) {
        return mergeFrom((SubmitRequest)other);
      } else {
    ...
    public Builder mergeFrom(SubmitRequest other) {
      if (other == SubmitRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      SubmitRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (SubmitRequest) e.getUnfinishedMessage();
  ...
  static {
    DEFAULT_INSTANCE = new SubmitRequest();
  }
